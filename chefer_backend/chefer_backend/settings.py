"""
Django settings for chefer_backend project.
...
SECRET_KEY = 'django-insecure-ifp))+^9a6a1%r+x-)$e$x9fee57=0uc00zvnni6p%=1f0=vp^'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.instagram_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'chefer_backend.wsgi.application'
